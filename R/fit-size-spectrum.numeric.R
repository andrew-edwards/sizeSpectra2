...
fit_size_spectrum.numeric <- function(dat,
  ...
  #  as a starting point for nlm for MLE of b for PLB model (unless b_start is
  #  specified). Everything after this is for PLB.

  if(is.null(b_start)){
    b_start <- 1/( log(x_min) - sum_log_x/length(x)) - 1
  }
