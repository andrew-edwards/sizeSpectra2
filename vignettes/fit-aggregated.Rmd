...
form. See [Quevedo et
al. (2026)](https://www.sciencedirect.com/science/article/pii/S2351989426001769)
for examples using the MLEbins method, for which we
have lengths that are converted to weights using species-specific length-weight
relationships. For code from that analysis see [here](https://github.com/andrew-edwards/sizeSpectraFit/tree/main/report/mediterranean).
...
and then fitting using the MLEbin method:
...
Quevedo, J., N. Bahamon, A.M. Edwards, M. Vigo, P. Couve, J. Aguzzi, J. Paramo,
and J.B. Company (2026). No-take reserve improves size spectra and community
structure of demersal megafauna in the Northwestern Mediterranean Sea.
